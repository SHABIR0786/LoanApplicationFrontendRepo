...
@Component({
  selector: "app-lone-option-step13",
  templateUrl: "./lone-option-step13.component.html",
  styleUrls: ["./lone-option-step13.component.css"],
})
export class LoneOptionStep13Component implements OnInit {
  constructor(
  ...
  proceedToNext(value) {
    this.formData.page_13 = value;
    this._loanOptionHomeBuyingDataService.data = this.formData;
    this._route.navigate(["app/buy-a-home-loan-options-animated-step14"]);
  }
}
