...
@Component({
  selector: "app-loan-app-side-bar",
  templateUrl: "./loan-app-side-bar.component.html",
  styleUrls: ["./loan-app-side-bar.component.css"],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LoanAppSideBarComponent
